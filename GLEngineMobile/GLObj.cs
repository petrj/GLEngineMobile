...
namespace GLEngineMobile
{
	...
	{		
		...
		{
				Logger.WriteToLog(String.Format("Name: {0}",Name));

				Logger.WriteToLog(Position.ToString());					
				Logger.WriteToLog(Rotation.ToString());					
			
				Logger.WriteToLog(String.Format("X Size : {0}",XSize));			
				Logger.WriteToLog(String.Format("Y Size : {0}",YSize));			
				Logger.WriteToLog(String.Format("Z Size : {0}",ZSize));					
				
				UpperLeft.WriteToLog();
				BottomRight.WriteToLog();
				Center.WriteToLog();					
		}*/
